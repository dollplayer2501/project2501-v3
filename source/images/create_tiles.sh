...
python3 ./source/images/create_tiles.py \
  ...
  ./source/images/screenshot..EndeavourOS_Qtile..large.png \
  --tyling_type 5tiles

magick ./source/images/screenshot..EndeavourOS_Qtile..large.png -resize 768x \
...
python3 ./source/images/create_tiles.py \
  ...
  ./source/images/screenshot..angle_minus_five_degrees..large.png \
  --tyling_type 5tiles

magick ./source/images/screenshot..angle_minus_five_degrees..large.png -resize 768x \
